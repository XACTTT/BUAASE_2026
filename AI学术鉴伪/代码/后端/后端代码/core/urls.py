...
urlpatterns = [
    ...
    path('detection/submit_text/', submit_text_detection, name='submit_text_detection'),
    path('detection/methods/', public_detection_methods, name='public_detection_methods'), # 新增：文本检测提交接口
    ...
    path('admin/models/detection-methods/', views_model_management.detection_methods_list, name='detection_methods_list'),
    path('admin/models/detection-methods/update/', views_model_management.detection_methods_update, name='detection_methods_update'),
    path('admin/models/org-detection-config/', views_model_management.org_detection_config_list, name='org_detection_config_list'),
    path('admin/models/org-detection-config/update/', views_model_management.org_detection_config_update, name='org_detection_config_update'),
    ...
    path('user_action_log/download/', UserActionLogDownloadView.as_view(), name='user_action_log_download'),
